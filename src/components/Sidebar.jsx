...
const NavLinks = ({ handleClick }) => (
  <div className="mt-10">
    {links.map((item, i) => (
      <NavLink key={i} className="flex flex-row justify-start items-center my-8 text-sm font-medium text-gray-400 hover:text-[#e09c42]" onClick={() => handleClick && handleClick()}>
